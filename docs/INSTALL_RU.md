...
```bash
# Установите Go вручную через утилиту 'g'
...
На старых дистрибутивах (Debian 12, Slackware) предкомпилированные бинарники могут не работать из-за несовместимости процессорных инструкций. Компиляция на вашем устройстве решает эту проблему.
